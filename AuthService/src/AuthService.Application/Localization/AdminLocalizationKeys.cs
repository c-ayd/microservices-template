namespace AuthService.Application.Localization
{
    public static class AdminLocalizationKeys
    {
        /** 
        ...
        public const string UserAlreadySoftDeleted = "user_already_soft_deleted";
    }
}
